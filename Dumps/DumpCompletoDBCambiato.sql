...
--
-- Host: localhost    Database: newadvancedweb
-- ------------------------------------------------------
...
CREATE TABLE `materiale` (
  ...
  `AnnoCorso` int(11) DEFAULT NULL,
  `Nome` varchar(20) NOT NULL,
  `Link` text NOT NULL,
  `Descrizione_it` varchar(50) DEFAULT NULL,
  `Descrizione_en` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`IDMateriale`),
  KEY `Corso` (`Corso`,`AnnoCorso`),
  CONSTRAINT `materiale_ibfk_1` FOREIGN KEY (`Corso`, `AnnoCorso`) REFERENCES `corso` (`IDCorso`, `Anno`)
...
INSERT INTO `materiale` VALUES (1,2,2018,'Base di dati','Materiale\\Base di dati.pdf','<p>Una base di dati</p>','<p>A Database</p>');
...
-- Dump completed on 2018-11-04 15:00:26
