CREATE DATABASE  IF NOT EXISTS `advancedweb` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `advancedweb`;
-- MySQL dump 10.13  Distrib 5.7.17, for macos10.12 (x86_64)
--
-- Host: 127.0.0.1    Database: advancedweb
-- ------------------------------------------------------
...
CREATE TABLE `cdl` (
  ...
  `AnnoInizio` int(11) NOT NULL,
  `AnnoFine` int(11) NOT NULL,
  `CFU` int(11) NOT NULL,
...
INSERT INTO `cdl` VALUES (1,'Informatica','Computer Science',2018,2019,180,0,'imgCDL\\Informatica.jpg','<p>Corso informatica triennale</p>','<p>Computer science course</p>','Inf','inf'),(2,'Magistrale Informatica','Master Computer Science',2018,2019,120,1,'imgCDL\\Magistrale Informatica.jpg','<p>Corso magistrale in Informatica</p>','<p>Master Degree in Computer Science</p>','L.M.I','M.C.S'),(3,'/','/',2018,2019,0,0,'','','','/','/');
...
INSERT INTO `corso` VALUES (1,'Reti neurali','Neural network','007','ita',1,12,2018,2019,'A',4),(2,'Laboratorio basi di dati','Lab Database','INF','Ita',1,12,2018,2019,'A',NULL),(3,'Teoria Dell\'Informazione','Information Theory','INF','Ita',1,6,2018,2019,'A',NULL),(4,'Algoritmi','Algoritmi','inf','ita',1,12,2017,2018,'A',NULL);
...
INSERT INTO `group_services` VALUES (1,1),(2,2),(1,3),(1,4),(1,5),(1,6),(2,7),(1,8),(2,9),(1,10),(2,11),(1,12),(1,13),(2,14),(1,15),(2,16),(1,17),(1,18),(1,19),(1,20),(2,21),(1,22),(1,23),(1,24);
...
INSERT INTO `sessione` VALUES ('GUYKeCA1ckKCidTwtbyUJbOhjtRrS8QE','2018-06-08 17:15:49',1);
...
INSERT INTO `utente` VALUES (1,'admin','password',NULL,1),(2,'gide','gide',1,2),(3,'fimi','ewvf7Nf1jC',2,2),(4,'admin2','password4',NULL,1);
...
-- Dump completed on 2018-10-14 20:06:38
